(() => {
  ...
  __commonjs = {
    13(exports, module) {
      // node_modules\turbolinks\dist\turbolinks.js
      (function() {
        var t = this;
        (function() {
          (function() {
        ...
        (function() {
          (function() {
            ...
            e.HeadDetails = function() {
              function t2(t3) {
                ...
                for (this.elements = {}, n2 = 0, a = t3.length; a > n2; n2++)
                  u = t3[n2], u.nodeType === Node.ELEMENT_NODE && (s = u.outerHTML, r2 = null != (e3 = this.elements)[s] ? e3[s] : e3[s] = {
                    type: i(u),
                    tracked: o(u),
                    elements: []
                  }, r2.elements.push(u));
            ...
            e.SnapshotRenderer = function(e2) {
              ...
              var e2;
              return e2 = document.createElement("meta"), e2.setAttribute("name", "turbolinks-permanent-placeholder"), e2.setAttribute("content", t3.id), {
                element: e2,
                permanentElement: t3
              };
            }, r = function(t3, e2) {
              ...
              return r.prototype.start = function() {
                ...
                return (e2 = this.getCachedSnapshot()) ? (t3 = this.shouldIssueRequest(), this.render(function() {
                  ...
                  return this.cacheSnapshot(), this.controller.render({
                    snapshot: e2,
                    isPreview: t3
                  }, this.performScroll), "function" == typeof (r2 = this.adapter).visitRendered && r2.visitRendered(this), t3 ? void 0 : this.complete();
                })) : void 0;
                ...
                return null != this.response ? this.render(function() {
                  ...
                  return this.cacheSnapshot(), this.request.failed ? (this.controller.render({
                    error: this.response
                  }, this.performScroll), "function" == typeof (t3 = this.adapter).visitRendered && t3.visitRendered(this), this.fail()) : (this.controller.render({
            ...
            e.Controller = function() {
              ...
              return r.prototype.start = function() {
                ...
                var o;
                return e.supported ? (o = this.getRestorationDataForIdentifier(n), this.startVisit(t3, r2, {
                  restorationData: o
                })) : window.location = t3;
                ...
                var n;
                return this.restorationIdentifier = r2, this.enabled ? (n = this.getRestorationDataForIdentifier(this.restorationIdentifier), this.startVisit(t3, "restore", {
                  restorationIdentifier: this.restorationIdentifier,
                  restorationData: n,
                  historyChanged: true
                }), this.location = e.Location.wrap(t3)) : this.adapter.pageInvalidated();
                ...
                var e2;
                return (e2 = this.view.getElementForAnchor(t3)) ? this.scrollToElement(e2) : this.scrollToPosition({
                  x: 0,
                  y: 0
                });
              }, r.prototype.scrollToElement = function(t3) {
                ...
                var e2, r2, n;
                return this.enabled && this.clickEventIsSignificant(t3) && (r2 = this.getVisitableLinkForNode(t3.target)) && (n = this.getVisitableLocationForLink(r2)) && this.applicationAllowsFollowingLinkToLocation(r2, n) ? (t3.preventDefault(), e2 = this.getActionForLink(r2), this.visit(n, {
                  action: e2
                })) : void 0;
                ...
                return null == t3 && (t3 = {}), e.dispatch("turbolinks:load", {
                  data: {
    ...
    3(exports, module) {
      ...
      if (true) {
        var ReactPropTypesSecret = __require(4 /* ./lib/ReactPropTypesSecret */);
    ...
    7(exports) {
      ...
      if (true) {
        (function() {
          "use strict";
          var _assign = __require(2 /* object-assign */);
          var checkPropTypes = __require(3 /* prop-types/checkPropTypes */);
    ...
    8(exports, module) {
      ...
      if (false) {
        ...
        module.exports = __require(7 /* ./cjs/react.development.js */);
      }
    },
...
For more info, visit https://fb.me/react-mock-scheduler`);
    ...
    6(exports, module) {
      ...
      if (false) {
        ...
        module.exports = __require(5 /* ./cjs/react-dom.development.js */);
      }
    },

    1() {
      // app\app.tsx
      const Turbolinks = __import(13 /* turbolinks */);
      const react = __import(8 /* react */);
      const react_dom = __import(6 /* react-dom */);
      Turbolinks.start();
      const App = () => {
        const words = "wow some ddwords";
        return react.default.createElement("h2", null, words);
      };
      react_dom.default.render(react.default.createElement(App, null), document.getElementById("app"));
    }
  };
  return __require(1);
})();
